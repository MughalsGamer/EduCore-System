...
// //  Fee Challan — one document per family, per billing month.
// //
// //  PURE DEBIT ENTRY. This document only records "how much was
// //  charged this month, broken down student-wise". It carries NO
// //  amountPaid / status / previousBalance — those concepts belong
// //  to the ledger, not to the challan itself.
// //
// //  The family's running balance (ledger) is always computed live
// //  as: sum(all challans' currentMonthTotal) - sum(all fee
// //  collections' amount). See FeeLedgerHelper / FeeCollectionProvider
// //  for that calculation.
// //
// //  Ledger-friendly fields (type/date/amount/familyDocId) are kept
// //  consistent with FeeCollectionModel so the two can later be
// //  merged into a single chronological ledger view.
// // ─────────────────────────────────────────────
// class FeeChallanModel {
//   String? id;
//   String challanNumber;      // e.g. CH-0001
