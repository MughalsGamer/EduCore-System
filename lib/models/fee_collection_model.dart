...
// //  against a family. This is the "Credit" side of
// //  the ledger; FeeChallanModel documents are the
// //  "Debit" side. balanceAfter is a snapshot so the
// //  history/receipt list never needs to re-derive it.
// // ─────────────────────────────────────────────
...
//   String fatherPhone;
//
//   // The challan this payment was actually applied against
//   // (always the family's LATEST challan at the time of payment).
//   String? challanId;
...
//       balanceBefore: (m['balanceBefore'] as num?)?.toDouble() ?? 0,
