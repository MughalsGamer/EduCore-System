...
//   }
//
//   // ★ NEW: Fetch all attendance records for one staff/teacher within a
//   // given month. `monthStart` and `monthEnd` are 'yyyy-MM-dd' strings
...
//   }
//
//   // ★ NEW: Save/update a single attendance record directly. Used by the
