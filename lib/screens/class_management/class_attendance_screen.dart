...
//       lastDate: DateTime.now(), // attendance for future dates doesn't make sense
//     );
//     if (picked != null) {
...
//           child: Row(
//             children: [
//               const Icon(Icons.calendar_today_rounded, size: 15, color: _purple),
//               const SizedBox(width: 8),
//               Text(_fmtDate(_selectedDate),
//                   style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: _purple)),
//               const Spacer(),
//               const Icon(Icons.keyboard_arrow_down, size: 16, color: _purple),
//             ],
//           ),
//         ),
//       ),
...
//   }
//
//   Widget _header(BuildContext context, ClassAttendanceModel att, {VoidCallback? onBack, VoidCallback? onDateTap}) {
//     return Container(
//       color: Colors.white,
...
//           ),
//           if (onDateTap != null)
//             IconButton(icon: const Icon(Icons.calendar_today_rounded, size: 18, color: _purple), onPressed: onDateTap),
//           if (att.locked)
//             TextButton.icon(
//               onPressed: () async {
