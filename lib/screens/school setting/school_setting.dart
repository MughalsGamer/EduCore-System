...
//               const SizedBox(height: 16),
//               _buildAccountInfoCard(isDesktop),
//             ],
//           ),
//         ),
//       );
...
//   }
//
//   // ── Account info card (read-only, matches screenshot's bottom block) ──
//   Widget _buildAccountInfoCard(bool isDesktop) {
//     return Container(
//       padding: const EdgeInsets.all(18),
//       decoration: BoxDecoration(
//         color: _kCard,
...
//       mainAxisSize: MainAxisSize.min,
//       children: [
//         Text(label, style: const TextStyle(fontSize: 11.5, color: _kSlate)),
