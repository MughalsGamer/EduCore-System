...
//   void _showHistory(BuildContext context, StaffMember m) {
//     // Build a combined, chronologically-sorted list from statusHistory,
//     // falling back to joiningDate/terminationDate if history log is empty
//     // (older records created before this feature existed).
//     final events = List<StatusEvent>.from(m.statusHistory);
//     if (events.isEmpty) {
//       if (m.joiningDate != null) {
//         events.add(StatusEvent(type: 'joined', date: m.joiningDate!));
//       }
//       if (m.terminationDate != null) {
//         events.add(StatusEvent(
//             type: 'terminated', date: m.terminationDate!, note: m.terminationNote));
//       }
//     }
...
//               Row(children: [
//                 Expanded(
//                   child: Text('${m.name} — Employment History',
...
//                   itemBuilder: (ctx, i) => _historyTile(events[i], isLast: i == events.length - 1),
//                 ),
//               ),
//             ],
//           ),
...
//               _actionBtn(Icons.history, _kGrey, () => _showHistory(context, m), tooltip: 'History'),
...
//               const SizedBox(width: 8),
//               Column(children: [
//                 _mobileIconBtn(Icons.history, _kGrey, () => _showHistory(context, m)),
//                 const SizedBox(height: 6),
