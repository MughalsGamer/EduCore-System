...
//
// import '../../models/class_model.dart';                // ★ for SchoolClass
// import '../../models/teacher.dart';
// import '../../providers/class_provider.dart';          // ★ for ClassProvider
// import '../../providers/subject_provider.dart';
// import '../../providers/teacher_provider.dart';
// import '../../services/firestore_service.dart';        // ★ for subjects
//
// // ─────────────────────────────────────────────────────────
// //  ★ REUSED multi-select subjects widget (copied from your
// //    class screen – you can also extract it to a shared file)
// // ─────────────────────────────────────────────────────────
...
//     final provider = context.watch<MuddulProvider>();   // adapt to your provider name
//     final allSubjects = provider.mudduls                // adapt to your subject list getter
//         .map((m) => m.subjectName)                       // adapt to your model field
//         .toSet()
//         .toList()
//       ..sort();
//
...
//   String _type = 'staff';          // default
//   String _gender = 'Male';
//   String _maritalStatus = 'Single';
//   String? _bloodGroup;
//   String _employmentType = 'Regular';
//   String _dob = '';
//   String? _assignedClass;          // ★ assigned class id or name
//   List<String> _subjects = [];     // ★ assigned subjects
//
//   // Image
//   File? _imageFile;
...
//       imageQuality: 80,        // optional initial quality
//     );
//     if (picked != null) {
//       setState(() {
...
//
//     // Compress new image if any
//     String? base64Image = _existingImageBase64;
//     if (_imageFile != null) {
//       base64Image = await _service.compressAndEncode(_imageFile!);
//     }
//
...
//                   child: (_imageFile == null && _existingImageBase64 == null)
