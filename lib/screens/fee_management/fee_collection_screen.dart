...
import 'fee_collection_history_screen.dart';
...
//  - App bar has a "History" button -> FeeCollectionHistoryScreen.
// ─────────────────────────────────────────────
...
class _FeeCollectionScreenState extends State<FeeCollectionScreen> {
  ...
  void _openHistory() {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => const FeeCollectionHistoryScreen()),
    );
  }
  void _openHome() {
    Navigator.of(context).push(
